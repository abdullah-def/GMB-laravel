    ...
    <div class="card-header p-4 border-bottom border-300 bg-soft">
      <div class="row g-3 justify-content-between align-items-center">
        <div class="col-12 col-md">
          <h4 class="text-900 mb-0" data-anchor="data-anchor">Welcome, <?php echo e(auth()->user()->name); ?></h4>
        </div>
      </div>
    </div>
...
6. Your custom extension should now be installed and visible.
  ...
  <script>
    $(document).on('click', '.download_request_btn', function(){
      window.open("<?php echo e(route('download')); ?>"); // open it in new tab, which will automatically close
      // window.location = "<?php echo e(route('notifications')); ?>";
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/user/documentation.blade.php ENDPATH**/ ?>