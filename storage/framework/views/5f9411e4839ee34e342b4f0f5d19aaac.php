              ...
              <div class="col-12 " style="height: 100%;">
                <div class="card border border-300 h-100 w-100 overflow-hidden">
                  ...
                  <div class="card-body px-5 position-relative">
                    ...
                    <?php if(auth()->user()->plan->auto_automation): ?>
                    ...
                    <div class="border-0 py-0 mt-1" style="display: flex;text-align: left;align-items: center;">
                      ...
                      <span class="me-2" style="font-weight: bold;">Remaining Balance: </span><span><?php echo e(auth()->user()->plan->responses); ?> Responses</span>
                    ...
                    <div class="border-0 py-0 mt-2" style="display: flex;text-align: left;align-items: center;">
                      ...
                      <span class="me-2" style="font-weight: bold;">Subscription Expiration: </span><span><?php echo e(auth()->user()->plan->ended_at); ?></span>
                    ...
                    <div class="border-0 py-0 mt-2" style="display: flex;text-align: left;align-items: center;">
                      ...
                      <span class="me-2" style="font-weight: bold;">Your Plan: </span><span><?php echo e(auth()->user()->plan->plan); ?></span>
                    ...
                    <div class="border-0 py-0 mt-2" style="display: flex;text-align: left;align-items: center;">
                      ...
                      <span class="me-2" style="font-weight: bold;">Automatic Renewal Status: </span><span><?php if($auto_renew): ?> inactive <?php else: ?> Active <?php endif; ?></span>
                    ...
                    <div class="border-0 py-0 mt-5" style="display: flex;text-align: left;align-items: flex-start;flex-direction: row;">
                      ...
                      <a href="<?php echo e(route('settingssubscription')); ?>" class="btn btn-primary me-2" type="button" style=" max-width: 370px; ">Subscription Management</a>
                  ...
                  <?php echo $__env->make('components.user.extra', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              ...
              <tr class="hover-actions-trigger btn-reveal-trigger position-static" onclick="viewwidget(2)">
                ...
                <td class="align-middle customer white-space-nowrap">
                  <div class="d-flex align-items-center text-900" >
                    <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo e($item->avatar); ?>" alt=""></div>
                    <h6 class="mb-0 ms-3 text-900"><?php echo e($item->name); ?></h6>
                  </div>
                </td>
                ...
                <td class="align-middle review" style="min-width:350px;">
                  <p class="fs--1 fw-semi-bold text-1000 mb-0"><?php echo e(\Illuminate\Support\Str::limit($item->review, 100, '...')); ?></p>
                </td>
                
                <td class="align-middle product white-space-nowrap"><div class="fw-semi-bold" ><?php echo e(\Illuminate\Support\Str::limit($item->response, 100, '...')); ?></div></td>

                <td class="align-middle text-end time white-space-nowrap">
                  <div >
                    <h6 class="text-1000 mb-0"><?php echo e($item->created_at); ?></h6>
                  </div>
                </td>
                ...
                <div class="offcanvas-body p-0">
                  <div class="p-5 p-md-6">
                    ...
                    <div class="mb-6">
                      ...
                      <p class="text-1000 mb-0"><?php echo e($item->review); ?></p>
                    </div>
                    <h2 class="fw-bold fs-2 mb-0 text-1000 mb-3">Response</h2>
                    <p class="text-1000 mb-0"><?php echo e($item->response); ?></p>
                  </div>
                </div>
              </div>
...
<script>
  ...
  getOptionChart = async (value) => {
    try {
        const response = await fetch(  "<?php echo e(route('get_chart_reviews')); ?>" + "?value="+ value );
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/user/home.blade.php ENDPATH**/ ?>