        ...
        <div class="w-full px-4">
          <div class="wow fadeInUp relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white  py-14 px-8 text-center sm:px-12 md:px-[60px]"
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
              ...
              <div class="mb-[22px]">
                <input id="email" type="email" name="email" placeholder="name@example.com" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus
...
unset($__errorArgs, $__bag); ?>" />
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="mb-2 inline-block text-base text-dark  hover:text-primary ">
              Forget Password?
            </a>
            <p class="text-base text-body-secondary">
              Not a member yet?
              <a href="<?php echo e(route('register')); ?>" class="text-primary hover:underline">
                Sign Up
              </a>
            </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/auth/login.blade.php ENDPATH**/ ?>