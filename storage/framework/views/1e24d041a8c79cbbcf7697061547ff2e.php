...
<?php echo $__env->make('components.guest.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <section id="contact" class="relative py-20 md:py-[120px]">
    ...
    <div class="absolute top-0 left-0 -z-[1] h-1/2 w-full bg-[#E9F9FF] -700 lg:h-[45%] xl:h-1/2"></div>
    <div class="container px-4">
      <div class="-mx-4 flex flex-wrap items-center">
        <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
          <div class="ud-contact-content-wrapper">
            <div class="ud-contact-title mb-12 lg:mb-[150px]">
              <span class="mb-6 block text-base font-medium text-dark ">
                CONTACT US
              </span>
              <h2 class="max-w-[260px] text-[35px] leading-[1.14] font-semibold text-dark ">
            ...
            <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
              <div class="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  <h5 class="mb-[18px] text-lg font-semibold text-dark ">Our Location</h5>
              ...
              <div class="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  <h5 class="mb-[18px] text-lg font-semibold text-dark ">How Can We Help?</h5>
                  <p class="text-base text-body-color ">support@ziko.ai</p>
        ...
        <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
          <div
            ...
            <form method="post" action="<?php echo e(route('ticket')); ?>">
              <?php echo csrf_field(); ?> 
              <div class="mb-[22px]">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/guest/contact.blade.php ENDPATH**/ ?>