...
<?php echo $__env->make('components.guest.nav_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div class="-mx-4 flex flex-wrap">
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/4">
          <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
            ...
            <a href="<?php echo e(route('how_it_works')); ?>"
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                ...
                <form method="GET" action="<?php echo e(route('plans.show')); ?>">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" id="price_list" name="slug"  value="<?php echo e($plans[0]->slug); ?>"/>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                ...
                <form method="GET" action="<?php echo e(route('plans.show')); ?>">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" id="price_list" name="slug"  value="<?php echo e($plans[1]->slug); ?>"/>
                  <button class="inline-block rounded-md bg-primary py-3 px-7 text-center text-base font-medium text-white transition hover:bg-blue-dark" type="submit" >Start Now</button>
                </form>
              </div>
            </div>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                ...
                <form method="GET" action="<?php echo e(route('plans.show')); ?>">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" id="price_list" name="slug"  value="<?php echo e($plans[2]->slug); ?>"/>
                  <button class="inline-block rounded-md bg-primary py-3 px-7 text-center text-base font-medium text-white transition hover:bg-blue-dark" type="submit" >Start Now</button>
                </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/guest/home.blade.php ENDPATH**/ ?>