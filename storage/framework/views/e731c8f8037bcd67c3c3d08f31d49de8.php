                ...
                <div class="card-body pe-md-0">
                    <div class="row align-items-center gx-0 gy-7">
                        ...
                        <div class="col-lg-7 col-xl-7 mb-5" style=" display: flex; align-items: center; justify-content: center; ">
                            <form id="payment-form" action="<?php echo e(route('subscription.extra')); ?>" method="POST" style=" width: 100%;">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/user/payment/extracheckout.blade.php ENDPATH**/ ?>