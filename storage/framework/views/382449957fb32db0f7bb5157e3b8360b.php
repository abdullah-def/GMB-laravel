        ...
        <div class="flex w-full items-center justify-between px-4">
          ...
          <div class="justify-end pr-16 flex items-center lg:pr-0">
            ...
            <div class="hidden lg:flex">
              ...
              <a href="<?php echo e(route('login')); ?>" class="loginBtn py-2 px-[22px] text-base font-medium text-white hover:opacity-70">
                Sign In
              </a>
              <a href="<?php echo e(route('register')); ?>"
                class="signUpBtn rounded-md bg-white bg-opacity-20 py-2 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">
...
<?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/components/guest/nav_home.blade.php ENDPATH**/ ?>