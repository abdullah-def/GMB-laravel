        ...
        <div class="w-full px-4">
          <div class="text-center">
            ...
            <p class="mb-5 text-base text-body-color ">
              Complete the form to Sign Up or Sign Up with Google.
            </p>
...
<div class="container">
    ...
    <div class="w-full px-4">
        ...
        <div class="mb-10 text-center">
            <a href="<?php echo e(route('home')); ?>" class="mx-auto inline-block max-w-[160px]">
        ...
        <?php if($errors->has('name') or $errors->has('email') or $errors->has('password')): ?>
        ...
        <form id="signup_form" method="POST" action="<?php echo e(route('register')); ?>">
            <?php echo csrf_field(); ?>


            <!-- name -->
            <div class="mb-[22px]">
            <input  id="name" type="text" placeholder="Name" name="name" value="<?php echo e(old('name')); ?>"  required autocomplete="name" autofocus
            class="border-stroke  bg-transparent w-full rounded-md border py-3 px-5 text-base text-body-color  placeholder:text-dark-6 outline-none transition focus:border-primary  focus-visible:shadow-none  <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" />
            ...
            <!-- email -->
            <div class="mb-[22px]">
            <input id="email" type="email" placeholder="name@example.com" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email"
            class="border-stroke  bg-transparent w-full rounded-md border py-3 px-5 text-base text-body-color  placeholder:text-dark-6 outline-none transition focus:border-primary  focus-visible:shadow-none <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
            ...
            class="border-stroke  bg-transparent w-full rounded-md border py-3 px-5 text-base text-body-color  placeholder:text-dark-6 outline-none transition focus:border-primary  focus-visible:shadow-none <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
            ...
            <div class="mb-[22px]" style="text-align: left;">
              ...
              <label class="form-label fs-9 text-transform-none" for="termsService">I accept the <a style="color: blue" href="<?php echo e(route('terms')); ?>">terms </a>and <a style="color: blue" href="<?php echo e(route('policy')); ?>">privacy policy</a></label>
            </div>
        ...
        <ul class="-mx-2 mb-9 flex justify-between">
            ...
            <a href="<?php echo e(route('google.redirect')); ?>"
                ...
                <span class="w-5/6 px-4 py-3  text-white " >Sign up with Google</span >
            </a>
            </li>
        ...
        <p class="mb-4 text-base text-body-secondary">
            ...
            <a href="<?php echo e(route('policy')); ?>" class="text-primary hover:underline">
            Policy
            </a>
            and
            <a href="<?php echo e(route('terms')); ?>" class="text-primary hover:underline">
            Terms
            </a>
        </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/auth/register.blade.php ENDPATH**/ ?>