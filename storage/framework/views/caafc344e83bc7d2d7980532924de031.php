<footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
      ...
      <div class="-mx-4 flex flex-wrap">
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
          <div class="mb-10 w-full">
            <a href="<?php echo e(route('home')); ?>" class="mb-6 inline-block max-w-[160px]">
              <img src="/assets/images/logo/logo-white.svg" alt="logo" class="max-w-full" />
            </a>
            <p class="mb-8 max-w-[270px] text-base text-gray-7">
              We revolutionize digital customer interactions through smart AI, crafting and posting thoughtful responses, saving time for busy business owners.
            </p>
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
          <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white">About Ziko AI</h4>
            <ul>
              <li>
                <a href="<?php echo e(route('home')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Home
                </a>
              </li>
              <li>
                <a href="<?php echo e(route('blog')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Blog
                </a>
              </li>
              <li>
                <a href="<?php echo e(route('about')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  About
                </a>
              </li>
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
          <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white">Terms</h4>
            <ul>
              <li>
                <a href="<?php echo e(route('how_it_works')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  How it works
                </a>
              </li>
              <li>
                <a href="<?php echo e(route('policy')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Privacy policy
                </a>
              </li>
              <li>
                <a href="<?php echo e(route('terms')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="<?php echo e(route('refund')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Refund policy
                </a>
              </li>
            </ul>
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
          <div class="mb-10 w-full">
            ...
            <ul>
              <li>
                <a href="<?php echo e(route('knowledgebase')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Knowledgebase
                </a>
              </li>
              <li>
                <a href="<?php echo e(route('contact')); ?>" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Contact Us
                </a>
              </li>
            </ul>
        ...
        <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
          <div class="mb-10 w-full">
            ...
            <?php $__currentLoopData = $posts_footer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <a href="<?php echo e(route('blog.post', ['post'=>$item->slug])); ?>"  class="group flex items-center gap-[22px]" >
                  <div class="overflow-hidden rounded h-48">
                    <img  src="<?php echo e($item->getThumbnailUrl()); ?>" alt="blog" style=" max-height: 48px; max-width: 70px; "/>
                  </div>
                  <span class="max-w-[180px] text-gray-7 text-base group-hover:text-white" >

                    <?php echo e(\Illuminate\Support\Str::limit($item->title, 30, '...')); ?>
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            <div class="my-1">
              <div class="-mx-3 flex items-center justify-center md:justify-start">
                <a href="<?php echo e(route('policy')); ?>" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                  Privacy policy
                </a>
                <a href="<?php echo e(route('terms')); ?>" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                  Terms of service
                </a>
              </div>
            </div>
          ...
          <div class="w-full px-4 md:w-1/3 lg:w-1/2">
            <div class="my-1 flex justify-center md:justify-end">
              <p class="text-base text-gray-7">
                © 2023-2024 Ziko AI - A brand of
                <a href="https://onewaybakery.com.au/" rel="nofollow noopner" target="_blank"
                  class="text-gray-1 hover:underline">
                  Oneway Lebanese Bakery
                </a>
              </p>
            </div>
          </div>
    ...
    <div>
      <span class="absolute left-0 top-0 z-[-1]">
        <img src="/assets/images/footer/shape-1.svg" data-src="/assets/images/footer/shape-1.svg" class="lazyload" alt="" loading="lazy" />
      </span>
  
      <span class="absolute bottom-0 right-0 z-[-1]">
        <img src="/assets/images/footer/shape-3.svg" data-src="/assets/images/footer/shape-3.svg" class="lazyload" alt="" loading="lazy" />
      </span>
...
<a href="javascript:void(0)" class="back-to-top fixed bottom-8 right-8 left-auto z-[999] hidden h-10 w-10 items-center justify-center rounded-md bg-primary text-white shadow-md transition duration-300 ease-in-out hover:bg-dark">
  <span class="mt-[6px] h-3 w-3 rotate-45 border-t border-l border-white"></span>
        ...
        </script><?php /**PATH D:\Mario\templetes\GMB_LARVEL\resources\views/components/guest/footer.blade.php ENDPATH**/ ?>