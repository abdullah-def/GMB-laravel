      ...
      <div class="-mx-4 flex flex-wrap">
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
          <div class="mb-10 w-full">
            ...
            <ul>
              <li>
                <a href="{{route('home')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Home
                </a>
              </li>
              <li>
                <a href="{{route('blog')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Blog
                </a>
              </li>
              <li>
                <a href="{{route('about')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  About
                </a>
              </li>
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
          <div class="mb-10 w-full">
            ...
            <ul>
              <li>
                <a href="{{route('how_it_works')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  How it works
                </a>
              </li>
              <li>
                <a href="{{route('policy')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Privacy policy
                </a>
              </li>
              <li>
                <a href="{{route('terms')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="{{route('refund')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Refund policy
                </a>
              </li>
            </ul>
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
          <div class="mb-10 w-full">
            ...
            <ul>
              <li>
                <a href="{{route('knowledgebase')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Knowledgebase
                </a>
              </li>
              <li>
                <a href="{{route('contact')}}" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                  Contact Us
                </a>
              </li>
            </ul>
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            <div class="my-1">
              <div class="-mx-3 flex items-center justify-center md:justify-start">
                <a href="{{route('policy')}}" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                  Privacy policy
                </a>
                <a href="{{route('terms')}}" class="px-3 text-base text-gray-7 hover:text-white hover:underline">
                  Terms of service
                </a>
              </div>
            </div>
