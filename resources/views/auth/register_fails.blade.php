                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-xl-6">
                                                    <label class="form-label" for="confirmPassword">Confirm
                                                        Password</label>
                                                    <input class="form-control form-icon-input" id="confirmPassword"
                                            ...
                                            <div class="form-check mb-3">
                                                ...
                                                <label class="form-label fs--1 text-none" for="termsService">I accept the <a
                                                        href="{{route('terms')}}">terms </a>and <a href="{{route('policy')}}">privacy
                                                        policy</a></label>
                                            </div>
                                        ...
                                        <div class="text-center">
                                            <a class="fs--1 fw-bold" href="{{ route('login') }}">Sign in to
                                                an existing account
                                            </a>
                                        </div>
